...
## Features
- Restructured repository, updated assets in version 4.0.0
- Changed license to Apache 2.0 in version 3.0.0
- Includes missing device symbol sprites in version 3.0.1
...
Read more in the [font portion](https://google.github.io/material-design-icons/#icon-font-for-the-web) of the full developer guide.
